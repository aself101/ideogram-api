 ...
 */
export type ColorPalettePreset = 'EMBER' | 'FRESH' | 'JUNGLE' | 'MAGIC' | 'MELON' | 'MOSAIC' | 'PASTEL' | 'ULTRAMARINE';
/**
 ...
 */
export type OperationKey = 'generate-v3' | 'edit-v3' | 'remix-v3' | 'reframe-v3' | 'replace-background-v3' | 'upscale' | 'describe';
/**
